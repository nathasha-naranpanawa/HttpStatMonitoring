package org.wso2.nash.monitoring.publisher.http;
...
public class EventBuilder  {
     ...
     */
    public Event prepareEvent(String streamId, WebappMonitoringEvent monitoringEvent) throws MonitoringPublisherException {

        System.out.println("publisher accessed");
